...
//------------------------------------------------------------------------------
  ...
  changeSettings: function(json) {
      ...
      if (json.contractsOn) {
          ...
          markerData.push({label: 'Done Planting', active: false, checked: false});
      }
      else{
          markerData.push({label: 'Done Planting', active: true, checked: false});
      }

      if (json.mgmtOptsOn) {
          markerData.push({label: 'Manage', active: false, checked: false});
      }
      markerData.push({label: 'Harvest', active: false, checked: false});
